...
SECRET_KEY = 'django-insecure-g!=x0z^sa+egifc_-v29uj5tn)98u1fcprp=+wpy6%y_$5!w1y'
...
# 6. Copy Key ID and Key Secret below
...
RAZORPAY_ENABLED = False  # Set to True when keys are configured
