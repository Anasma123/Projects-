...
class ViewTutor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ViewTutorPage(title: 'View Reply'),
    );
  }
}

class ViewTutorPage extends StatefulWidget {
  const ViewTutorPage({super.key, required this.title});

  final String title;

  @override
  State<ViewTutorPage> createState() => _ViewTutorPageState();
}
...
class _ViewTutorPageState extends State<ViewTutorPage> {
  ...
  Future<void> ViewTutor() async {
    ...
    try {
      ...
      String url = '$urls/myapp/student_ViewTutor/';
